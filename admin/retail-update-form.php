...
<body>
    ...
    <?php
        $id=$_REQUEST['myid'];
        $details=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM retail_popjob WHERE id='$id'")); 
    ?>
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Retail Job Update Form</li>
							</ol>
						</nav>
					</div>
				...
				<div class="col-xl-6 mx-auto">
					...
					<div class="card">
						<div class="card-body p-4">
							...
							<h5 class="mb-4">Retail Update Form</h5>
							<form class="row g-3" method="POST" action="elements/redirect" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
		                            <div class="d-md-flex d-grid align-items-center gap-3">
                                        <input class="btn btn-primary px-4" type="submit" name="retailpopjob" value="UPDATE">	
		                            </div>
	                            </div>
